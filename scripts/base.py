...
model_specs_8gpu = [
    ...
    # {"ds_config": "configs/deepspeed/ds2_llama.json", "run_prefix": "Llama3-8B", "pretrained": "meta-llama/Llama-3.1-8B", "train_batch": 1, "train_epochs": 6, "output_home": "output-lfs-dl026"},
    ...
    # {"ds_config": "configs/deepspeed/ds2_llama.json", "run_prefix": "Ministral-8B", "pretrained": "mistralai/Ministral-8B-Instruct-2410", "train_batch": 1, "train_epochs": 6, "output_home": "output-lfs-dl026"},
]

model_specs_16gpu = [
    # {"ds_config": "configs/deepspeed/ds3_t5.json", "run_prefix": "FlanT5-11B", "pretrained": "google/flan-t5-xxl", "train_batch": 1, "train_epochs": 6, "output_home": "output-lfs-dl026"},
