...
BEAM_SIZE=1
MODEL_NAME_OR_PATH=output/llama31-8b-base-task-adaptation/checkpoint-1236
OUTPUT_DIR=output/llama31-8b-task-adaptation-beam${BEAM_SIZE}
RUN_NAME=llama31-8b-experiment
