...
def main(  # --pretrained output/GNER-zeroshot/FlanT5-Base-BL/checkpoint-8250 --eval_file data/gner/crossner_ai-debug=10.jsonl
        ...
        per_device_eval_batch_size: Annotated[int, typer.Option("--per_device_eval_batch_size")] = 50,
        run_version: Annotated[str, typer.Option("--run_version")] = "GNER-T5-large-v2=100,50",
